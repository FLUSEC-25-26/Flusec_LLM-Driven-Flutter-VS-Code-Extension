...
| 🧮 **Insufficent Input Validation Advisor (IVS)** | Flags missing or weak input validation that can cause logic flaws or injection risks, combining **rules + AST reasoning + contextual metadata**.                                                                                                                                               |
