// src/llm.ts
//
// This file talks to Ollama running locally.
// Your hover queue calls getLLMFeedback().
//
// ✅ You can later upgrade the prompt to return JSON always, like:
// { "why": "...", "fix": [".."], "example": "..." }
// Then format.ts will render it nicely.
