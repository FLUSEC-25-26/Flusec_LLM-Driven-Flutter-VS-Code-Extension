...
// // Import Dashboards
// import { openDashboard } from "./web/hsd/dashboard.js";    // HSD
// import { openIvdDashboard } from "./web/ivd/dashboard.js"; // IVD
...
// 1️⃣ Import the new IVD Rule Manager
...
export function activate(context: vscode.ExtensionContext) {
  ...
  // 4. IVD Rule Manager (This was missing!) 🛑
  context.subscriptions.push(
