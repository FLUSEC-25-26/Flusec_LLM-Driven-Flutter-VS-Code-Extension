...
// import { openArcDashboard } from "./web/arc/dashboard.js";
...
//   context.subscriptions.push(
//     vscode.commands.registerCommand("flusec.openArcDashboard", () => {
//       vscode.window.showInformationMessage("FLUSEC: ARC Cohesion Dashboard is launching soon!");
//       // Later this will be: openArcDashboard(context);
//     })
//   );
